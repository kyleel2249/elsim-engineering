...
const siteDescription =
  'ELSIM Engineering (www.elsimengineeringlimited.com) designs, installs, tests and maintains electrical installations, solar power systems, transformers and power distribution for commercial and industrial clients across Ghana and West Africa.';
const ogDescription =
...
const siteJsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      url: siteUrl,
      name: 'ELSIM Engineering',
      alternateName: 'www.elsimengineeringlimited.com',
      description: siteDescription,
